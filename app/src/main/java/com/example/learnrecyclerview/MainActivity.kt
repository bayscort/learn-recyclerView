...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dates = arrayOf(
            ...
            " 19 Juni 1922 – 1 Oktober 1965",
            "3 Oktober 1920 – 7 Oktober 1981",
            "10 Oktober 1907 – 11 Juni 1962",
            "2 Mei 1889 – 26 April 1959",
            "12 Agustus 1902 – 14 Maret 1980",
            "24 Januari 1916 – 29 Januari 1950",
            " 6 Juni 1901 – 21 Juni 1970",
            "22 Januari 1903 – 12 September 1958",
            "2 Juni 1897 – 21 Februari 1949"
    ...
    private fun getUserData() {
        ...
        for(i in imageId.indices){
            val hero = Hero(imageId[i], name[i], dates[i], description[i])
        ...
        adapter.setOnItemClickListener(object : Adapter.onItemClickListener{
            override fun onItemClick(position: Int) {
                ...
                intent.putExtra("name", newArrayList[position].heroName)
                intent.putExtra("image", newArrayList[position].heroImage)
                intent.putExtra("description", newArrayList[position].heroDescription)
